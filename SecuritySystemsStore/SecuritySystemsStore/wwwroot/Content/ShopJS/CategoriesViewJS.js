$(function () {
    ...
    /* Декларираме и инициализираме необходимите променливи */

    var newCatA = $("a#newcata"); /*Клас линк за добавяне*/
    var newCatTextInput = $("#newcatname"); /*Клас текстовото поле за въвеждане*/
    var ajaxText = $("span.ajax-text"); /*Клас зареждане на картинки*/
    var table = $("table#pages tbody"); /*Клас таблица за ивеждане*/

    /* Пишем функция за прихващане на натискане на Enter */
